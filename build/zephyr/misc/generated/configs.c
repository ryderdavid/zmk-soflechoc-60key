...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_DISPLAY_DEDICATED_THREAD_STACK_SIZE, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_COMBO_MAX_PRESSED_COMBOS, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_COMBO_MAX_COMBOS_PER_KEY, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_COMBO_MAX_KEYS_PER_COMBO, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_NICE_VIEW, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_NICE_VIEW_ADAPTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_SOFLE_RIGHT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_VDB_SIZE, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_DPI_DEF, 161);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_BITS_PER_PIXEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NICE_VIEW_WIDGET_STATUS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SHARP_LS0XX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_ADAPTIVE_KEY_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_LEADER_KEY_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_ADAPTIVE_KEY_MAX_TRIGGER_CONDITIONS, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_ADAPTIVE_KEY_MAX_BINDINGS, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_ADAPTIVE_KEY_WAIT_MS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_ADAPTIVE_KEY_TAP_MS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_ADAPTIVE_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_ADAPTIVE_KEY_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LEADER_MAX_KEYS_PER_SEQUENCE, 6);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LEADER_MAX_SEQUENCES, 24);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_LEADER_KEY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LS0XX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LS0XX_VCOM_THREAD_PRIO, 3);
