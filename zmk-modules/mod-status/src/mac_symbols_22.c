 ...
 * Size: 22 px
 * Bpp: 1
 * Opts: --font /System/Library/Fonts/SFCompact.ttf --bpp 1 --size 22 --range 0x20,0x21E7,0x2303,0x2325,0x2318 --format lvgl --output mac_symbols_22.c --lv-include lvgl.h --no-compress
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 37, .adv_w = 312, .box_w = 15, .box_h = 10, .ofs_x = 2, .ofs_y = 5},
    {.bitmap_index = 56, .adv_w = 318, .box_w = 16, .box_h = 15, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 86, .adv_w = 340, .box_w = 18, .box_h = 15, .ofs_x = 1, .ofs_y = 0}
};
